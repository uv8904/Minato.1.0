...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6964203412 8023726997').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002086319581').split()]  # Channel id for auto indexing (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1003140286992 -1002536320197")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org/vTelegraphBot-08-29-30')    # QR code image for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://yuvi123:yuvi123@cluster0.hlyhypg.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://uvjangra:uvjangra@cluster0.cmjdvgq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
# Movie Notification & Update Settings
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATION', True))  # Notification On (True) / Off (False)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002677255756'))  # Notification of sent to your channel
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/movie_backup_group")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/movie_backup_group")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/movie_backup_group")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "f4c4000ef9a3fefa39f4a9c7f270f6e93772a6d9") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "http://onylinks.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "f4c4000ef9a3fefa39f4a9c7f270f6e93772a6d9")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "http://onylinks.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "f4c4000ef9a3fefa39f4a9c7f270f6e93772a6d9")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "http://onylinks.com") # Shortener website for third website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movie_isavilable') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/hmmmmw876') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/movie_backup_group') # Update channel link for the bot
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", f"<a href=https://t.me/hmmmmw876>@hmmmw876 {file_name} </a>")   # Custom caption for files
