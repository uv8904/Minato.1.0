...
💎 ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴘʟᴀɴ → /myplan</b>"""
    ...
    FAMPAY_ORDER_TXT = """<b>⚡ ꜰᴀᴍᴘᴀʏ ᴘᴀʏᴍᴇɴᴛ</b>

◈ ᴘʟᴀɴ → <b>{plan}</b>
◈ ᴘᴀʏ ᴛʜɪꜱ ᴇxᴀᴄᴛ ᴀᴍᴏᴜɴᴛ → <b>{payable}</b>
◈ ᴏʀᴅᴇʀ ɪᴅ → <code>{order_id}</code>
◈ ᴜᴘɪ ɪᴅ → <code>{upi_id}</code>
◈ ᴠᴀʟɪᴅ ꜰᴏʀ → {expiry} ᴍɪɴᴜᴛᴇs

⚠️ ᴀᴍᴏᴜɴᴛ ᴋᴇ ꜱᴀᴀᴛʜ ᴘᴀɪꜱᴇ ({paise}) ʙʜɪ ᴡᴀɪꜱᴇ ʜɪ ʙʜᴇᴊᴇᴍ — ɪꜱɪ sᴇ ᴀᴀᴘᴋᴀ ᴘᴀʏᴍᴇɴᴛ ᴘᴇʜᴄᴀɴᴀ ᴊᴀᴀᴛᴀ ʜᴀɪ.

📲 ɴᴇᴇᴄʜᴇ ᴋᴀ ʙᴜᴛᴛᴏɴ ᴅʙᴀᴋᴇ ᴜᴘɪ ᴀᴘᴘ ᴍᴇ ᴘᴀʏ ᴋᴀʀᴇᴍ, ʏᴀ ǫʀ sᴄᴀɴ ᴋᴀʀᴇᴍ.
ᴘᴀʏᴍᴇɴᴛ ᴋᴇ ʙᴀᴀᴅ ✅ ʙᴜᴛᴛᴏɴ ᴅʙᴀʏᴇᴍ — ᴘʀᴇᴍɪᴜᴍ ᴀᴘɴᴇ ᴀᴘ ᴀᴅᴅ ʜᴏ ᴊᴀʏᴇɢᴀ.</b>"""
...
ᴘᴀʏᴍᴇɴᴛ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴠᴇʀɪꜰʏ ʜᴏ ᴊᴀʏᴇɢᴀ. ᴀɢᴀʀ ᴜᴛʀ ᴍɪʟ ɢᴀʏᴀ ʜᴀɪ ᴛᴏ ʏᴇ ᴄᴏᴍᴍᴀɴᴅ ʙʜᴇᴊᴇᴍ:

<code>/utr {order_id} 123456789012</code>

ᴜᴛʀ ᴅᴇɴᴇ ᴋᴇ ʙᴀᴀᴅ ᴇᴋ ʙᴀʀ ᴀᴜʀ ᴄᴏɴꜰɪʀᴍ ᴋᴀʀɴᴀ ʜᴏɢᴀ. ᴜᴛʀ ꜱᴜʙᴍɪᴛ ᴋᴀʀɴᴀ ᴘʀᴇᴍɪᴜᴍ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴀᴄᴛɪᴠᴀᴛᴇ ɴᴀʜɪ ᴋᴀʀᴛᴀ — ᴘʜʟᴇ ᴠᴇʀɪꜰʏ ʜᴏɢᴀ.</b>"""
...
ᴜᴘᴀʀ ᴋᴀ ᴜᴛʀ ᴅᴏʙᴀʀᴀ ᴄʜᴇᴄᴋ ᴋᴀʀᴇᴍ. ✅ ᴄᴏɴꜰɪʀᴍ ᴅʙᴀɴᴇ ᴘᴀʀ ʜɪ ʏᴇ ᴀᴅᴍɪɴ ʀᴇᴠɪᴇᴡ ᴋᴇ ʟɪʏᴇ ʙʜᴇᴊᴀ ᴊᴀʏᴇɢᴀ.</b>"""
...
ᴀᴅᴍɪɴ/ᴀᴜᴛᴏ-ᴠᴇʀɪꜰɪᴇʀ ᴘᴀʏᴍᴇɴᴛ ᴄʜᴇᴄᴋ ᴋᴀʀᴇɢᴀ. ᴄᴏɴꜰɪʀᴍ ʜᴏᴛᴇ ʜɪ ᴘʀᴇᴍɪᴜᴍ ᴀᴄᴛɪᴠᴇ ʜᴏ ᴊᴀʏᴇɢᴀ.</b>"""

    FAMPAY_UTR_CANCELLED_TXT = """<b>✏️ ᴜᴛʀ ɪɴᴘᴜᴛ ᴄᴀɴᴄᴇʟ ʜᴏ ɢᴀʏᴀ.</b>

ꜱᴀʜɪ ᴜᴛʀ ᴋᴇ ꜱᴀᴀᴛʜ ᴅᴏʙᴀʀᴀ ʙʜᴇᴊᴇᴍ: <code>/utr {order_id} 123456789012</code>"""
