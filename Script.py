...
➤ 💸 ᴜᴘɪ ɪᴅ → <code>{advitiyaaaa@fam}</code>
...
•─────•─────────•─────•
🏷️ <a href='https://t.me/yuviiiii_i'>ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴘʀᴏᴏꜰ</a>
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @yuviiiii_i
...
‼️ ᴀꜰᴛᴇʀ ꜱᴇɴᴅɪɴɢ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ɢɪᴠᴇ ᴜꜱ ꜱᴏᴍᴇᴛɪᴍᴇꜱ ᴛᴏ ᴀᴅᴅ ʏᴏᴜ ɪɴ ᴘʀᴇᴍɪᴜᴍ ʟɪꜱᴛ."""  
    ...
    # Search results "Sᴇɴᴅ Aʟʟ" button: the button is visible to everyone, but
    # only premium users may use it. Alerts are plain text (Telegram does not
...
😺 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/yuviiiii_i'>ᴏᴡɴᴇʀ</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
‼️ ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ.</b>"""
    ...
    # ------------------------------------------------------------------ #
    # FamPay auto-approval (docs/FAMPAY_SETUP.md)
    # ------------------------------------------------------------------ #
    FAMPAY_PLANS_TXT = """<b>⚡ ꜰᴀᴍᴘᴀʏ — ᴀᴜᴛᴏ ᴀᴘᴘʀᴏᴠᴀʟ</b>

ᴀᴘɴᴀ ᴘʟᴀɴ ᴄʜᴜɴᴇᴍ — ᴘᴀʏᴍᴇɴᴛ ᴋᴇ ʙᴀᴀᴅ ᴘʀᴇᴍɪᴜᴍ <b>ᴀᴘɴᴇ ᴀᴘ</b> ᴀᴅᴅ ʜᴏ ᴊᴀʏᴇɢᴀ, ᴋᴏɪ sᴄʀᴇᴇɴsʜᴏᴛ ɴᴀʜɪ, ᴋᴏɪ ᴡᴀɪᴛ ɴᴀʜɪ ✅
...
⏱️ ᴏʀᴅᴇʀ ᴠᴀʟɪᴅ ꜰᴏʀ {expiry} ᴍɪɴᴜᴛᴇs

💎 ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴘʟᴀɴ → /myplan</b>"""

    FAMPAY_PLAN_DETAIL_TXT = """<b>🧾 ᴘʟᴀɴ ᴅᴇᴛᴀɪʟꜱ</b>

◈ ᴘʟᴀɴ → <b>{plan}</b>
◈ ᴀᴍᴏᴜɴᴛ → <b>{amount}</b>

<blockquote>🎁 <b>ɪs ᴘʟᴀɴ ᴍᴇ ᴋʏᴀ ᴍɪʟᴇɢᴀ</b> :</blockquote>
○ ᴅɪʀᴇᴄᴛ ꜰɪʟᴇs — ɴᴏ ɴᴇᴇᴅ ᴛᴏ ᴏᴘᴇɴ ʟɪɴᴋs
○ ᴀᴅ-ꜰʀᴇᴇ ᴇxᴘᴇʀɪᴇɴᴄᴇ
○ ʜɪɢʜ-ꜱᴘᴇᴇᴅ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋs
○ ᴍᴜʟᴛɪ-ᴘʟᴀʏᴇʀ ꜱᴛʀᴇᴀᴍɪɴɢ ʟɪɴᴋs
○ ᴜɴʟɪᴍɪᴛᴇᴅ ᴍᴏᴠɪᴇs & ꜱᴇʀɪᴇs
○ ꜰᴜʟʟ ᴀᴅᴍɪɴ ꜱᴜᴘᴘᴏʀᴛ

•─────•─────────•─────•
🧾 <b>ᴘᴀʏᴍᴇɴᴛ ᴋᴇ ʙᴀᴀᴅ ᴄᴏɴꜰɪʀᴍᴀᴛɪᴏɴ ᴋᴀʀɴᴀ ʜᴀɪ:</b>
1️⃣ ǫʀ / ᴘᴀʏᴍᴇɴᴛ ᴋᴀ <b>sᴄʀᴇᴇɴsʜᴏᴛ</b> ʏᴀʜɪɴ ʙʜᴇᴊɪʏᴇ
2️⃣ sᴀᴀᴛʜ ᴍᴇ <b>ᴜᴛʀ ɴᴜᴍʙᴇʀ</b> ʏᴀʜɪɴ ʟɪᴋʜ ᴅɪᴊɪʏᴇ

ᴅᴏɴᴏ ᴍɪʟᴛᴇ ʜɪ ᴠᴇʀɪꜰʏ ʜᴏᴋᴇ ᴘʀᴇᴍɪᴜᴍ ᴀᴄᴛɪᴠᴇ ʜᴏ ᴊᴀʏᴇɢᴀ ✅

🏦 ᴜᴘɪ ɪᴅ → <code>{upi_id}</code>
⏱️ ᴏʀᴅᴇʀ ᴠᴀʟɪᴅ ꜰᴏʀ {expiry} ᴍɪɴᴜᴛᴇs

💸 <b>ᴘᴀʏ ɴᴏᴡ</b> ᴅᴀʙᴀᴛᴇ ʜɪ ǫʀ ᴍɪʟ ᴊᴀʏᴇɢᴀ — ᴇxᴀᴄᴛ ᴀᴍᴏᴜɴᴛ (ᴘᴀɪꜱᴇ ꜱᴀᴛʜ) ǫʀ ᴍᴇꜱꜱᴀɢᴇ ᴘᴇ ᴅɪᴋʜᴇɢᴀ.</b>"""

    FAMPAY_ORDER_TXT = """<b>✅ ᴀᴀᴘɴᴇ ʏᴇ ᴘʟᴀɴ ᴄʜᴏᴏꜱᴇ ᴋɪʏᴀ ʜᴀɪ</b>

◈ ᴘʟᴀɴ → <b>{plan}</b>
◈ ᴀʙ ᴘᴀʏ ᴋᴀʀᴇᴍ → <b>{payable}</b>
◈ ᴏʀᴅᴇʀ ɪᴅ → <code>{order_id}</code>
◈ ᴜᴘɪ ɪᴅ → <code>{upi_id}</code>
◈ ᴠᴀʟɪᴅ ꜰᴏʀ → {expiry} ᴍɪɴᴜᴛᴇs

⚠️ ᴇxᴀᴄᴛ ᴀᴍᴏᴜɴᴛ ʙʜᴇᴊᴇᴍ — ᴘᴀɪꜱᴇ ({paise}) ʙʜɪ ᴡᴀɪꜱᴇ ʜɪ ʀᴀʜᴇᴍ.

📲 ɴᴇᴇᴄʜᴇ ǫʀ sᴄᴀɴ ᴋᴀʀᴇᴍ, ʏᴀ ʏᴇ ʟɪɴᴋ ᴛᴀᴘ ᴋᴀʀᴋᴇ sɪᴅʜᴀ ᴜᴘɪ ᴀᴘᴘ ᴍᴇ ᴘᴀʏ ᴋᴀʀᴇᴍ:
{pay_link}

🧾 <b>ᴘᴀʏᴍᴇɴᴛ ᴋᴇ ʙᴀᴀᴅ ᴄᴏɴꜰɪʀᴍᴀᴛɪᴏɴ ᴋᴇ ʟɪʏᴇ:</b>
1️⃣ ǫʀ / ᴘᴀʏᴍᴇɴᴛ ᴋᴀ <b>sᴄʀᴇᴇɴsʜᴏᴛ</b> ʙʜᴇᴊᴇᴍ
2️⃣ sᴀᴀᴛʜ ᴍᴇ <b>ᴜᴛʀ ɴᴜᴍʙᴇʀ</b> ʙʜɪ ʟɪᴋʜ ᴅᴏ

ᴜᴛʀ + sᴄʀᴇᴇɴsʜᴏᴛ ᴀᴀᴛᴇ ʜɪ ᴠᴇʀɪꜰʏ ʜᴏᴋᴇ ᴘʀᴇᴍɪᴜᴍ ᴀᴅᴅ ʜᴏ ᴊᴀʏᴇɢᴀ ✅</b>"""

    FAMPAY_ORDER_PLACED_TXT = """<b>✅ ᴏʀᴅᴇʀ ᴘʟᴀᴄᴇᴅ</b>

◈ ᴏʀᴅᴇʀ ɪᴅ → <code>{order_id}</code>
◈ ᴀᴍᴏᴜɴᴛ → <b>{payable}</b>

ᴀʙ ᴄᴏɴꜰɪʀᴍᴀᴛɪᴏɴ ᴋᴇ ʟɪʏᴇ:
• ᴘᴀʏᴍᴇɴᴛ / ǫʀ ᴋᴀ <b>sᴄʀᴇᴇɴsʜᴏᴛ</b> ʙʜᴇᴊᴇᴍ
• ᴀᴜʀ <b>ᴜᴛʀ ɴᴜᴍʙᴇʀ</b> ʟɪᴋʜ ᴅᴏ

ᴅᴏɴᴏ ᴍɪʟᴛᴇ ʜɪ ʀᴇᴠɪᴇᴡ ʜᴏᴋᴇ ᴘʀᴇᴍɪᴜᴍ ᴀᴄᴛɪᴠᴇ ʜᴏ ᴊᴀʏᴇɢᴀ ✅</b>"""

    FAMPAY_UTR_CONFIRM_TXT = """<b>🧾 ᴜᴛʀ ᴄᴏɴꜰɪʀᴍ ᴋᴀʀᴇᴍ</b>

◈ ᴏʀᴅᴇʀ ɪᴅ → <code>{order_id}</code>
◈ ᴀᴍᴏᴜɴᴛ → <b>{payable}</b>
◈ ᴜᴛʀ → <code>{utr}</code>

ᴜᴘᴀʀ ᴋᴀ ᴜᴛʀ ᴅᴏʙᴀʀᴀ ᴄʜᴇᴄᴋ ᴋᴀʀᴇᴍ. ✅ ᴄᴏɴꜰɪʀᴍ ᴅʙᴀɴᴇ ᴘᴀʀ ʏᴇ ʀᴇᴠɪᴇᴡ ᴋᴇ ʟɪʏᴇ ᴊᴀʏᴇɢᴀ.

📸 ᴀɢᴀʀ sᴄʀᴇᴇɴsʜᴏᴛ ᴀʙʜɪ ɴᴀʜɪ ʙʜᴇᴊᴀ ᴛᴏ ᴄᴏɴꜰɪʀᴍ ᴋᴇ ʙᴀᴀᴅ ǫʀ/ᴘᴀʏᴍᴇɴᴛ sᴄʀᴇᴇɴsʜᴏᴛ ʙʜɪ ʙʜᴇᴊ ᴅᴇɴᴀ.</b>"""

    FAMPAY_UTR_SUBMITTED_TXT = """<b>✅ ᴜᴛʀ ʀᴇᴠɪᴇᴡ ᴋᴇ ʟɪʏᴇ ʙʜᴇᴊ ᴅɪʏᴀ ɢᴀʏᴀ</b>

◈ ᴏʀᴅᴇʀ ɪᴅ → <code>{order_id}</code>
◈ ᴜᴛʀ → <code>{utr}</code>

📸 ᴀʙ ǫʀ / ᴘᴀʏᴍᴇɴᴛ ᴋᴀ <b>sᴄʀᴇᴇɴsʜᴏᴛ</b> ʙʜᴇᴊ ᴅᴏ ᴄᴏɴꜰɪʀᴍᴀᴛɪᴏɴ ᴋᴇ ʟɪʏᴇ.
ᴠᴇʀɪꜰʏ ʜᴏᴛᴇ ʜɪ ᴘʀᴇᴍɪᴜᴍ ᴀᴄᴛɪᴠᴇ ʜᴏ ᴊᴀʏᴇɢᴀ ✅</b>"""

    FAMPAY_UTR_CANCELLED_TXT = """<b>✏️ ᴜᴛʀ ɪɴᴘᴜᴛ ᴄᴀɴᴄᴇʟ ʜᴏ ɢᴀʏᴀ.</b>

ꜱᴀʜɪ ᴜᴛʀ ɴᴜᴍʙᴇʀ ʏᴀʜɪɴ ᴍᴇꜱꜱᴀɢᴇ ᴍᴇ ʟɪᴋʜ ᴋᴇ ʙʜᴇᴊ ᴅᴏ, ᴀᴜʀ ǫʀ/ᴘᴀʏᴍᴇɴᴛ ᴋᴀ sᴄʀᴇᴇɴsʜᴏᴛ ʙʜɪ ᴀᴛᴛᴀᴄʜ ᴋᴀʀᴇᴍ."""

    FAMPAY_SCREENSHOT_OK_TXT = """<b>📸 sᴄʀᴇᴇɴsʜᴏᴛ ᴍɪʟ ɢᴀʏᴀ</b>

◈ ᴏʀᴅᴇʀ ɪᴅ → <code>{order_id}</code>
{utr_line}
ᴀʙ ᴀɢᴀʀ ᴜᴛʀ ᴀʙʜɪ ɴᴀʜɪ ʙʜᴇᴊᴀ ᴛᴏ <b>ᴜᴛʀ ɴᴜᴍʙᴇʀ</b> ʏᴀʜɪɴ ʟɪᴋʜ ᴋᴇ ʙʜᴇᴊ ᴅᴏ.
ᴅᴏɴᴏ ᴍɪʟᴛᴇ ʜɪ ᴄᴏɴꜰɪʀᴍᴀᴛɪᴏɴ ʜᴏ ᴊᴀʏᴇɢɪ ✅</b>"""

    FAMPAY_PROOF_COMPLETE_TXT = """<b>✅ ᴜᴛʀ + sᴄʀᴇᴇɴsʜᴏᴛ ʀᴇᴠɪᴇᴡ ᴘᴀʀ ʜᴀɪ</b>

◈ ᴏʀᴅᴇʀ ɪᴅ → <code>{order_id}</code>
◈ ᴜᴛʀ → <code>{utr}</code>

ᴀᴅᴍɪɴ/ᴀᴜᴛᴏ-ᴠᴇʀɪꜰɪᴇʀ ᴄʜᴇᴄᴋ ᴋᴀʀ ʀᴀʜᴀ ʜᴀɪ. ᴄᴏɴꜰɪʀᴍ ʜᴏᴛᴇ ʜɪ ᴘʀᴇᴍɪᴜᴍ ᴀᴄᴛɪᴠᴇ ʜᴏ ᴊᴀʏᴇɢᴀ 🎉</b>"""

    FAMPAY_PAID_TXT = """<b>✅ ᴘᴀʏᴍᴇɴᴛ ʀᴇᴄᴇɪᴠᴇᴅ — ᴘʀᴇᴍɪᴜᴍ ᴀᴄᴛɪᴠᴇ!</b>
...
ᴛʜᴀɴᴋ ʏᴏᴜ ꜰᴏʀ ᴘᴜʀᴄʜᴀsɪɴɢ 🎉 ᴇɴᴊᴏʏ ᴘʀᴇᴍɪᴜᴍ!"""

    FAMPAY_EXPIRED_TXT = """<b>⌛ ᴏʀᴅᴇʀ ᴇxᴘɪʀᴇᴅ</b>

ᴏʀᴅᴇʀ <code>{order_id}</code> ᴋᴀ ᴛɪᴍᴇ sᴀᴍᴀᴘᴛ ʜᴏ ɢᴀʏᴀ ʜᴀɪ (ᴘᴀʏᴍᴇɴᴛ ɴᴀʜɪ ᴍɪʟᴀ)।

ᴀɢᴀʀ ᴀᴀᴘɴᴇ ᴘᴀʏ ᴋᴀʀ ᴅɪʏᴀ ᴛᴏ ᴋᴏɪ ʙᴀᴀᴛ ɴᴀʜɪ — ᴀᴀᴘᴋᴀ ᴘᴀʏᴍᴇɴᴛ ᴀᴅᴍɪɴ ᴋᴏ ꜰᴏʀᴡᴀʀᴅ ᴋᴀʀ ᴅɪʏᴀ ɢᴀʏᴀ ʜᴀɪ, ᴛʜᴏᴅɪ ᴅᴇʀ ᴍᴇ ᴘʀᴇᴍɪᴜᴍ ᴀᴅᴅ ʜᴏ ᴊᴀʏᴇɢᴀ ✅

ɴᴀʏᴀ ᴏʀᴅᴇʀ ʙᴀɴᴀɴᴇ ᴋᴇ ʟɪʏᴇ → /fampay</b>"""

    FAMPAY_CANCELLED_TXT = """<b>🚫 ᴏʀᴅᴇʀ ᴄᴀɴᴄᴇʟʟᴇᴅ</b>

ᴏʀᴅᴇʀ <code>{order_id}</code> ᴄᴀɴᴄᴇʟ ᴋᴀʀ ᴅɪʏᴀ ɢᴀʏᴀ ʜᴀɪ। ɴᴀʏᴀ ᴏʀᴅᴇʀ ʙᴀɴᴀɴᴇ ᴋᴇ ʟɪʏᴇ → /fampay</b>"""
...
ꜱᴏᴜʀᴄᴇ ᴏᴡɴᴇʀ :<a href=https://t.me/yuviiiii_i>💘Ý𐌵𝘃ῖῖ💘✨</a>\n """
